...
func fabricar():
	...
	if lista.count("o") >= 2 and lista.count("c") >= 1:
		...
		var icon = load("res://arte/vlad/satanas atomico/satanas atomico/co2.png")
		$"../notificacao".mostrar_notificacao("dioxido de carbono", icon )
		pass
	if lista.count("o") >= 1 and lista.count("h") >= 2:
		...
		limpar_lista()
		var icon = load("res://arte/vlad/satanas atomico/satanas atomico/nao sei oq atomico.png")
		$"../notificacao".mostrar_notificacao("agua", icon )
		pass
	pass
